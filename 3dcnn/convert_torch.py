...
def lua_recursive_model(module,seq):
    for m in module.modules:
        ...
        if name == 'SpatialConvolution' or name == 'nn.SpatialConvolutionMM':
            ...
            n = nn.ConvTranspose3d(m.nInputPlane,m.nOutputPlane,(m.kT,m.kW,m.kH),(m.dT,m.dW,m.dH),(m.padT,m.padW,m.padH),m.groups)
            copy_param(m,n)
            add_submodule(seq, n)
...
def lua_recursive_source(module):
    ...
    for m in module.modules:
        ...
        if name == 'SpatialConvolution' or name == 'nn.SpatialConvolutionMM':
            ...
            s += ['nn.ConvTranspose3d({},{},{},{},{},{})'.format(m.nInputPlane,
                m.nOutputPlane,(m.kT,m.kW,m.kH),(m.dT,m.dW,m.dH),(m.padT,m.padW,m.padH),m.groups)]
        elif name == 'SpatialReplicationPadding':
